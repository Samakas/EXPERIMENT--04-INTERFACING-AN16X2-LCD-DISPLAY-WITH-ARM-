...
int main(void)
{
  ...
  Lcd_PortType ports[] = { GPIOA, GPIOA, GPIOA, GPIOA };
    ...
    Lcd_cursor(&lcd, 0,1);
    Lcd_string(&lcd, "SAMAKASH R S");
    Lcd_cursor(&lcd, 1,1);
    Lcd_string(&lcd, "212223230182");
  /* USER CODE END 2 */
...
## Output screen shots of proteus  :
 ![Screenshot 2024-11-01 183100](https://github.com/user-attachments/assets/dc2ec5af-9979-47ca-8d27-c600dd3a41b4)

 
 ## CIRCUIT DIAGRAM (EXPORT THE GRAPHICS TO PDF AND ADD THE SCREEN SHOT HERE): 
 ![Screenshot 2024-11-01 183221](https://github.com/user-attachments/assets/7cfa1592-860f-4153-a5b4-ee71cbdb0837)
